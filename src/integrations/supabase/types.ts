  ...
  public: {
    Tables: {
      ...
      discussion_participants: {
        ...
        Relationships: [
          {
            foreignKeyName: "discussion_participants_thread_id_fkey"
            columns: ["thread_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "discussion_participants_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
      ...
      event_with_views: {
        ...
        Relationships: [
          {
            foreignKeyName: "event_with_views_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: true
            referencedRelation: "events"
            referencedColumns: ["id"]
      ...
      users_badge: {
        ...
        Relationships: [
          {
            foreignKeyName: "users_badge_badge_id_fkey"
            columns: ["badge_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "users_badge_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users_view"
            referencedColumns: ["id"]
